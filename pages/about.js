  ...
  return (
    <div className={styles.background}>
      ...
      <div className={styles.main}>
        ...
        <h3 className={styles.paragraph}> we built this at EthSF2022 to bring power back to the people. Sunwoo and I both had a hard time quitting our jobs, and heavily leaned on our network for support.
        Oftentimes, the hardest part is admitting that something is not working. 
        ...
        <h3 className={styles.paragraph}> your network will lift you up. </h3>
